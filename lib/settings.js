...
export const data = {
  ...
  nowPlayingWidget: { label: "Now playing", type: "checkbox" },
  airpodsWidget: { label: "AirPods battery", type: "checkbox" },
  notificationsWidget: { label: "Notification badges", type: "checkbox" },
  nextMeetingWidget: { label: "Next meeting", type: "checkbox" },
  audioVizWidget: { label: "Audio visualization", type: "checkbox" },
  ...
  nowPlayingWidgetOptions: {
    label: "Now playing",
  },

  airpodsWidgetOptions: {
    label: "AirPods battery",
  },
  ...
  audioVizWidgetOptions: {
    ...
    infos: [
      "Requires <a href='https://github.com/karlstav/cava'>cava</a> (brew install cava).",
      "The bundled config captures system audio via a CoreAudio process tap, which does not require any permission.",
      "The number of bars is defined in the cava config file (bars option).",
    ],
  },
  cavaBinaryPath: {
    label: "Path to cava binary",
    type: "text",
    placeholder: "example: /opt/homebrew/bin/cava",
    fullWidth: true,
  },
  cavaConfigPath: {
    label: "Path to cava config file",
    type: "text",
    placeholder: "example: ./simple-bar/lib/scripts/cava.conf",
    fullWidth: true,
  },
...
export const defaultSettings = {
  ...
  audioVizWidgetOptions: {
    ...
    cavaConfigPath: "./simple-bar/lib/scripts/cava.conf",
  },
  userWidgets: {
    userWidgetsList: {},
  },
